    ...
    public static class ConstantsEnumsExtensions
    {
        ...
        public static string getValue(this ConstantsEnums constantsEnums) {
            ...
            return constantsEnums switch {
                ...
                ConstantsEnums.BASE_URI_CANCELLATION => "https://gateway.qa.sandboxhubredeban.com/rbmcalidad/calidad/api/dir/v3.0.0/Directory/keytype/{keyType}/key/{keyValue}",
